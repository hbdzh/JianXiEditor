...
namespace JianXiEditor.Utility.DrapDrop
{
    public class DropFilesExtension
    {
        public static readonly DependencyProperty IsEnabledProperty = DependencyProperty.RegisterAttached(
            "IsEnabled", typeof(bool), typeof(DropFilesExtension), new FrameworkPropertyMetadata(default(bool), OnPropChanged)
            {
